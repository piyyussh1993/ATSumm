...
def attention_decoder(decoder_inputs, initial_state, encoder_states, enc_topicwords_probs_batch, enc_padding_mask, cell, initial_state_attention=False, pointer_gen=True, use_coverage=False, prev_coverage=None):
  """
  Args:
  ...
  with variable_scope.variable_scope("attention_decoder") as scope:
    ...
    def attention(decoder_state, enc_topicwords_probs_batch, coverage=None):
      ...
      with variable_scope.variable_scope("Attention"):
        ...
        #attn_dist = modify_attention(attn_dist, enc_topicwords_probs_batch)
...
def modify_attention (attn_dist, topicwords_probs):
    attn_dist = attn_dist + tf.nn.softmax(topicwords_probs)#+ tf.softmax(topicwords_probs)
    return attn_dist
