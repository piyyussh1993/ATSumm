...
class BeamSearchDecoder(object):
  ...
  def decode(self):
    ...
    while True:
      ...
      if FLAGS.single_pass:
        self.write_for_rouge(original_abstract_sents, decoded_words, counter, article_withunks) # write ref summary and decoded summary to file, to eval with pyrouge later
  ...
  def write_for_rouge(self, reference_sents, decoded_words, ex_index, article_orig):
    ...
    with open(article_file, "w", encoding='utf-8') as f:
      #for idx,sent in enumerate(article_orig):
      #  f.write(sent) if idx==len(article_orig)-1 else f.write(sent+"\n")
